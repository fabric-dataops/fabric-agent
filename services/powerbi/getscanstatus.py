...
class GetScanStatusService:
    headers = None

    def get_scan_status(self, access_token: str, scan_id: str):
        ...
        endpoint_url = f"{app.config.POWER_BI_API_URL}v1.0/myorg/admin/workspaces/scanStatus/{scan_id}"
